...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2023 at 06:48 PM
...
INSERT INTO `orders` (`id`, `reservation_id`, `item_id`) VALUES
(2, 14, 24);
...
(14, 9, 'Reservation', '01234567891', 5, '2023-06-05 21:50:00', 2);
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `reservation_id` FOREIGN KEY (`reservation_id`) REFERENCES `reservation` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
